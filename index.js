...
// nestedFunction can access internal because they are in the same scope, myFunction()
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(){ 
    const array = zooAnimals.map(element => element.animal_name.toLowerCase());
      return array;
  }
  ...
  */
  ...
  function lowPopulationAnimals(){
    const lowPops = zooAnimals.filter(element => element.population < 5); 
      return lowPops;
  }
  ...
  */
  ...
  function USApop(){
    return zooAnimals.reduce((element, zooAnimals) => element + zooAnimals.population, 0);
  }
...
function greeting(firstName, lastName){
  ...
  // console.log(greeting('Drew', 'Gomez'));
...
const cuboidTwo = new CuboidMaker(Cuboid);
